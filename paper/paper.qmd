---
title: "Crime in Toronto"
author: 
  - Yuanyi (Leo) Liu
thanks: "Code and data are available at: https://github.com/leoyliu/Crime-in-Toronto."
date: today
date-format: long
...
# Read the data
summary_table <- read.csv(here("data/analysis_data/summary_table.csv"), check.names = FALSE)
...
# Read the data
two_types_crime <- read.csv(here("data/analysis_data/two_types_crime.csv"), check.names = FALSE)
